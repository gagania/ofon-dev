...
//                $pnumber = 1;
        ...
        $totalData = $this->user_admin_model->getData(0,$limit,$whereSearch);
        $result = $this->user_admin_model->getData($this->_limit,$limit,$whereSearch);
    ...
    function searchTemplate($data) {
        ...
        foreach($data as $index => $value) {
            $template .= '<tr class="odd gradeX">
                                ...
                                <td>'.(isset($value['user_type']) ? $this->_appType[$value['user_type']] : '').'</td>
                            </tr>';
